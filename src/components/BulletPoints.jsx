...
export const BulletPoints = () => {
  return (
    <>
      <Headings
        title="Pourquoi choisir GestiCom ?"
        subtitle="Un outil intuitif, puissant et adapté à vos besoins"
      />
      <Container>
        <div className="w-full max-w-6xl mx-auto py-5 lg:py-10 space-y-10 lg:space-y-10">
